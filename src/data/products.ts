...
export const products: Product[] = [
  {
    ...
    categoryId: "1",
    variations: [{ id: "v55-0", name: "Indisponível no momento", inStock: false }],
    tags: ["mentolado"],
    featured: false,
  ...
  },
  {
    ...
    variations: [
      ...
      { id: "v80-3", name: "Menta Ice", inStock: true },
      { id: "v80-4", name: "Uva Ice", inStock: true },
      { id: "v80-5", name: "Melancia Ice", inStock: true },
  ...
  },
  {
    ...
    categoryId: "1",
    variations: [
      { id: "v155-1", name: "Morango Kiwi", inStock: true },
      { id: "v155-2", name: "Uva Ice", inStock: true },
      { id: "v155-3", name: "Melancia Ice", inStock: true },
      { id: "v155-4", name: "Abacaxi Ice", inStock: true },
      { id: "v155-5", name: "Morango Melancia", inStock: true },
      { id: "v155-6", name: "Menta Ice", inStock: true },
      { id: "v155-7", name: "Maracujá Kiwi Goiaba", inStock: true },
    ],
    tags: ["popular"],
    featured: true,
    createdAt: "2026-03-30",
  ...
  },
  {
    ...
    categoryId: "1",
    variations: [{ id: "v250-0", name: "Indisponível no momento", inStock: false }],
    tags: ["novo"],
    featured: false,
  ...
  },
  {
    ...
    variations: [
      ...
      { id: "v300-2", name: "Melancia Dragon Fruit", inStock: true },
      { id: "v300-3", name: "Melancia Mix", inStock: true },
    ],
  ...
  },
  {
    ...
    variations: [
      ...
      { id: "v400-2", name: "Uva Ice X Morango", inStock: true },
      { id: "v400-3", name: "Uva Pop X Pêssego Ice", inStock: true },
      { id: "v400-4", name: "Triple Mango", inStock: true },
      { id: "v400-5", name: "Morango Kiwi", inStock: true },
    ],
    tags: ["novo", "premium"],
    featured: true,
    createdAt: "2026-03-31",
  ...
  {
    id: "8",
    name: "Elfbar BC15K - 15.000 Puffs",
    ...
    categoryId: "2",
    variations: [
      { id: "bc15k-1", name: "Melancia Ice", inStock: true },
      { id: "bc15k-2", name: "Morango Kiwi", inStock: true },
      { id: "bc15k-3", name: "Menta Ice", inStock: true },
      { id: "bc15k-4", name: "Maracujá Kiwi Goiaba", inStock: true },
    ],
    tags: ["novo"],
    featured: false,
    createdAt: "2026-03-31",
  ...
  },
  {
    ...
    categoryId: "2",
    variations: [
      { id: "gh23k-1", name: "Melancia Ice", inStock: true },
      { id: "gh23k-2", name: "Uva Ice", inStock: true },
      { id: "gh23k-3", name: "Morango Banana", inStock: true },
      { id: "gh23k-4", name: "Pêssego Manga Melancia", inStock: true },
  ...
  },
  {
    ...
    categoryId: "2",
    variations: [
      { id: "45kpro-1", name: "Melancia Ice", inStock: true },
      { id: "45kpro-2", name: "Uva Ice", inStock: true },
      { id: "45kpro-3", name: "Maracujá Kiwi Goiaba", inStock: true },
      { id: "45kpro-4", name: "Morango Kiwi", inStock: true },
    ],
    tags: ["novo", "premium"],
    featured: false,
    createdAt: "2026-03-31",
