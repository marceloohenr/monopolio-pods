...
export const products: Product[] = [
  ...
  },
  {
    ...
    variations: [
      ...
      { id: "v80-8", name: "Maca Verde", inStock: true },
      { id: "v80-9", name: "Manga Limao", inStock: true },
  ...
  },
  {
    ...
    categoryId: "1",
    variations: [
      { id: "v155-1", name: "Maracuja Kiwi Goiaba", inStock: true },
      ...
      { id: "v155-9", name: "Maca Verde", inStock: true },
      { id: "v155-10", name: "Tropical Acai", inStock: true },
    ],
    tags: ["popular"],
    featured: true,
    createdAt: "2026-03-30",
  ...
  },
  {
    ...
    categoryId: "1",
    variations: [
      { id: "v250-1", name: "Morango Ice", inStock: true },
      { id: "v250-2", name: "Melancia Ice", inStock: true },
      { id: "v250-3", name: "Mint", inStock: true },
    ],
    tags: ["novo", "popular"],
    featured: false,
  ...
  },
  {
    ...
    variations: [
      ...
      { id: "v400-2", name: "Blue Razz Ice", inStock: true },
      { id: "v400-3", name: "Mint", inStock: true },
    ],
    tags: ["novo", "premium"],
    featured: true,
    createdAt: "2026-03-31",
